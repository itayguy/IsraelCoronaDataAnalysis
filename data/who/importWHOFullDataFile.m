function [date1,location,new_cases,new_deaths,total_cases,total_deaths] = importWHOFullDataFile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [DATE1,LOCATION,NEW_CASES,NEW_DEATHS,TOTAL_CASES,TOTAL_DEATHS] =
...
%
% Example:
%   [date1,location,new_cases,new_deaths,total_cases,total_deaths] = importfile('full_data.csv',2, 2554);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/03/17 12:46:17
...
new_cases = dataArray{:, 3};
new_deaths = dataArray{:, 4};
total_cases = dataArray{:, 5};
total_deaths = dataArray{:, 6};
